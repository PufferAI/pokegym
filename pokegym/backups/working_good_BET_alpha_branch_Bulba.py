...
STATE_PATH = __file__.rstrip("environment.py") + "States1"
...
##########################################################################################################################
    ...
    # if ram_map.mem_val(self.game, 0xCFC4): # if font is loaded
    #         for i in range(ram_map.mem_val(self.game, 0xD4B0)): #
    #             print(f'0xD4B1 + 2 * i == {ram_map.mem_val(self.game, (0xD4B1 + 2 * i))}')
    #             print(f'0xD4B1 + 2 * i + 1 == {ram_map.mem_val(self.game, (0xD4B1 + 2 * i + 1))}')

    #         print(f'0xD361 {ram_map.mem_val(self.game, (0xD361))}')
    #         print(f'0xD362 {ram_map.mem_val(self.game, (0xD362))}')
    #         print(f'0xD363 {ram_map.mem_val(self.game, (0xD363))}')
    #         print(f'0xD364 {ram_map.mem_val(self.game, (0xD364))}')
                                                
    #         print(f'(npc_x, npc_y): ({ram_map.npc_x(self.game, 0)}, {ram_map.npc_y(self.game, 0)})')
    #         # check if we are talking to a hidden object:
    #         if ram_map.mem_val(self.game, 0xCD3D) != 0x0 and ram_map.mem_val(self.game, 0xCD3E) != 0x0:                     
    #             self.seen_hidden_objs.add((ram_map.mem_val(self.game, 0xD35E), ram_map.mem_val(self.game, 0xCD3F)))
    #             print(f'ram_map.mem_val(self.game, 0xCD3E): {ram_map.mem_val(self.game, 0xCD3E)}, ram_map.mem_val(self.game, 0xCD3D): {ram_map.mem_val(self.game, 0xCD3D)}')
    #             print(f'ram_map.mem_val(0xCD3F): {ram_map.mem_val(self.game, 0xCD3F)}')
    #             # get information for player
    #         else:
    ...
    #                     mindex = npc_id
    #                     minv = npc_dist
    #             if mindex != 0: # comment on purpose (if you want) to increment on interaction w/ signs
